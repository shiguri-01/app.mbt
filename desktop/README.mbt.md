...
or more windows with `App::create_window`. The default bridge name is
`moonbitDesktop`. Native code can use `Window::handle_default`,
`Window::handle_sync_default`, or `Window::handle_deferred_default`; frontend
code can use
